...
} from "./getValueAndLabel";

export const getLabel = (
  accessKey: "subject" | "predicate" | "object",
  triple: RDFResource | undefined,
  triples: RDFResource[],
) => {
...
export const getTripleClass = (
  ...
  if (type.includes("#")) return type.split("#")?.pop() ?? "No Class";
  if (type.includes("/")) return type.split("/")?.pop() ?? "No Class";
  return type;
};
